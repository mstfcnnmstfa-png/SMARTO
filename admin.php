<?php
// admin.php - تم تعديله لاستخدام $NAMERO العام
$SALEH = 7816487928;
    ...
    if (file_exists($Namero13_file)) {
        ...
        if ($status == "enabled") {
            ...
            bot('editMessageText', [
                ...
                'text' => "🚫 *تم قفل التوجيه*",
                'parse_mode' => 'Markdown',
                'reply_markup' => json_encode([ 'inline_keyboard' => [ [['text' => '⬅️ رجوع', 'callback_data' => '@ypiu5']] ] ])
            ]);
        } else {
    ...
    bot('sendMessage', [
        ...
        'reply_markup' => json_encode([
            'inline_keyboard' => [
                ...
                [['text'=>'مطور البوت☠️','url'=>"https://t.me/ypiu5"], ['text' => '🛠 الإذاعة', 'callback_data' => 'broadcast']],
...
if ($data == "back_to_admin") {
    $developer_link = file_exists($NAMERO . "developer_link.txt") ? file_get_contents($NAMERO . "developer_link.txt") : "https://t.me/ypiu5";

...
'inline_keyboard' => [
[['text' => '⬅️ رجوع', 'callback_data' => '@ypiu5']]
]
]) 
]);
} else {
...
if (($text == "/start" || $data == "@ypiu5" || $data == "back") && ($chat_id == $SALEH || in_array($chat_id, $admins))) {
...
[['text'=>'مطور البوت☠️','url'=>"https://t.me/ypiu5"],
...
[['text' => $forwarding_button_text, 'callback_data' => 'toggle_forwarding'], ['text' => $notification_button_text, 'callback_data' => 'toggle_notification']],
 ...
 [['text' => 'اعدادات بوت الرشق 📮 ', 'callback_data' => '@ypiu5']]
]
])
]);
}
if ($data == "back_to_admin") {
$developer_link = file_exists("developer_link.txt") ? file_get_contents("developer_link.txt") : "https://t.me/ypiu5";
$channel_link = file_exists("channel_link.txt") ? file_get_contents("channel_link.txt") : "https://t.me/TJUI9";
bot('editMessageText', [
'chat_id' => $chat_id2,
'message_id' => $message_id,
...
[['text' => "رجوع ♻️", 'callback_data' => '@ypiu5']],
],
]),
]);
}
...
$Namero = json_decode(file_get_contents("Namero.json"), true);
...
file_put_contents("Namero.json", json_encode($Namero, JSON_PRETTY_PRINT));
}
}
} 
...
bot('sendMessage', [
'chat_id' => $chat_id,
'text' => "*• تم استبدال النسخة الاحتياطية بنجاح ✅*",
'parse_mode' => "markdown"
]);
...
$buttons[] = [['text' => '⬅️ رجوع', 'callback_data' => '@ypiu5']];
bot('editMessageText', [
'chat_id' => $chat_id2,
'message_id' => $message_id,
...
if ($data == "@ypiu5" && ($chat_id2 == $SALEH || in_array($chat_id2, $admins))) {
$start_time = microtime(true);
$Namero13 = file_exists($Namero13_file) ? file_get_contents($Namero13_file) : "disabled";
$forwarding_button_text = $Namero13 == "enabled" ? "🚫 قفل التوجيه" : "✅ فتح التوجيه";
$Namero11 = file_exists($Namero11_file) ? file_get_contents($Namero11_file) : "disabled";
...
'parse_mode' => 'Markdown',
'reply_markup' => json_encode([
'inline_keyboard' => [[['text' => "اشتراك @$channel", 'url' => "https://t.me/$channel"]]]
])
]);
exit;
}

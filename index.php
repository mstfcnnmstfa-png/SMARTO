...
$json_info = $bot_info;
$start_file = __DIR__ . '/start_message.txt';
...
function getAdminKeyboard($settings) {
    ...
    return [
        'inline_keyboard' => [
            ...
            [['text' => "رجوع", 'callback_data' => "@ypui5"]]
        ]
    ];
}

// ========== دوال الأقسام والمتجر والطلبات (كاملة) ==========

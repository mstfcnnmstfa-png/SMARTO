...
$Namero['rshaq'] = "✅" ;
$Namero= json_encode($Namero,32|128|265);
file_put_contents("$NAMERO/Namero.json",$Namero); 
} 
$rshaq = $Namero['rshaq'];
...
[['text'=>"تعيين معلومات ",'callback_data'=>"set_api_token"],
 ['text'=>"تعيين الهديه",'callback_data'=>"set_daily_gift"]],
[['text'=>"الهديه اليوميه $daily_gift_status",'callback_data'=>"toggle_daily_gift"],
 ['text'=>"رابط الدعوة $invite_link_status",'callback_data'=>"toggle_invite_link"]],
...
[['text'=>"فتح الرشق",'callback_data'=>"onNamero"],
 ['text'=>"قفل الرشق",'callback_data'=>"ofNamero"]],
[['text'=>"تعيين $currency الدعوة",'callback_data'=>"set_invite_reward"],
 ['text'=>"الحد الأدنى للتحويل",'callback_data'=>"set_min_order"]],
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'reply_markup'=>json_encode(getAdminKeyboard($settings))
]);
}
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'reply_markup'=>json_encode(getAdminKeyboard($settings,$currency))
]);
}
...
bot('answerCallbackQuery',[
'callback_query_id'=>$update->callback_query->id,
'text'=>"تم تغيير حالة قسم الاستبدال!"
]);
bot('editMessageReplyMarkup',[
'chat_id'=>$chat_id,
'message_id'=>$message_id,
...
'reply_markup'=>json_encode([
 'inline_keyboard'=>[
 [['text'=>"رجوع",'callback_data'=>"SMITH_MATRIX" ]], 
]
])
]);
}
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"• *مرحبا بك في قسم الاستبدال ♾️:*",
'parse_mode'=>"markdown",
'reply_markup'=>json_encode(['inline_keyboard'=>$btns])
]);
}

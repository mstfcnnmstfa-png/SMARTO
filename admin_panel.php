...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_settings'])) {
    ...
    $settings['Ch'] = $_POST['channel_link'] ?? 'https://t.me/S_P_P1';
            ...
            <div class="form-card" style="margin-bottom:14px;">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" name="channel_link" class="form-control" value="<?php echo htmlspecialchars($settings['Ch'] ?? 'https://t.me/S_P_P1'); ?>" required>
                    </div>
                </div>
            </div>
